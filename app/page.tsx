...
import { Check, Fan, Lightbulb } from 'lucide-react';
...
export default function Home() {
    ...
    const getLightShadow = () => {
        ...
        switch (colorTemp) {
            case 'warm':
                shadowColor = `255, 229, 180`; 
                break;
            case 'neutral':
                shadowColor = `240, 248, 255`; // yellow-300
                break;
            case 'cool':
                shadowColor = `135, 206, 235`; // blue-300
                break;
            case 'daylight':
                shadowColor = `255, 182, 193`; // blue-500
                break;
            default:
                                    ...
                                    <div className='max-w-md mx-auto bg-[#131B2A] p-6 border border-gray-500 rounded-2xl'>
                                        ...
                                        <div className='mb-4'>
                                            ...
                                            <div className='flex space-x-2'>
                                                ...
                                                >
                                                    <div className='w-full h-full bg-[#FFE5B4] rounded-lg'></div>
                                                </button>
                                                <button
                                                ...
                                                >
                                                    <div className='w-full h-full bg-[#F0F8FF] rounded-lg'></div>
                                                </button>
                                                <button
                                                ...
                                                >
                                                    <div className='w-full h-full bg-[#87CEEB] rounded-lg'></div>
                                                </button>
                                                <button
                                                ...
                                                >
                                                    <div className='w-full h-full bg-[#FFB6C1] rounded-lg'></div>
                                                </button>
                                            </div>
                                        </div>
